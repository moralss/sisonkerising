...
CELLWIDTH = int(WINDOW_WIDTH / CELL_SIZE)
CELLHEIGHT = int(WINDOW_HEIGHT / CELL_SIZE)
...
def main():
    global FRAMES_PER_SECONDCLOCK, DISPLAYSURF, BASICFONT
...
def drawPressKeyMsg():
    pressKeySurf = BASICFONT.render('Press enter key to play.', True, WHITE)
